...
Route::get('trang-thai-don-hang/{id}','clientController@getBillStatus')->name('getBillStatus');
...
Route::group(['prefix'=>'/admin','middleware'=>'adminLogin'],function(){
    ...
    Route::get('gui-mail/{id}','adminController@getEmail')->name('getEmail');    
    Route::get('danh-sach-binh-luan/{productId}','adminController@getListComment')->name('getListComment');
    Route::get('an-binh-luan/{productId}','adminController@getHideComment')->name('getHideComment');
    Route::get('hien-binh-luan/{productId}','adminController@getUnHideComment')->name('getUnHideComment');
    Route::get('trang-thai-don-hang/{idBill}','adminController@confirmBill')->name('confirmBill');
    Route::get('xoa-don-hang/{idBill}','adminController@postDeleteBill')->name('postDeleteBill');    
...
Route::group(['prefix' => '/'], function () {
    ...
    Route::get('/','clientController@getHomePage')->name('homePageClient');
    ...
    Route::group(['middleware' => 'filter'], function() {
        Route::resource('getDetailProduct', 'clientController@getDetailProduct');
    });
    Route::post('binh-luan/{id}','clientController@AddComment')->name('AddComment');   
    ...
    Route::group(['prefix' => '/'], function () {
        ...
        Route::post('gio-hang-ajax','clientController@getAddToCartAjax')->name('giohangajax');
