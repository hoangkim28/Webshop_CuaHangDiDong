                                ...
                                <form action="{{route('addProductPage')}}" method="post" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3 col-lg-3">
                                                ...
                                                <input type="number" class="form-control"name="txt_unitPrice" required min="1">
                                            </div> <!-- End: Giá bán  -->
                                            <div class="form-group col-md-3 col-lg-3">
                                                <label for="">Giá sale*</label>
                                                <input type="number" class="form-control"name="txt_promotionPrice" required min="0">
                                            </div> <!-- End: giá sale  -->
                                            <div class="form-group col-md-3 col-lg-3">
                                                <label for="">Giá nhập*</label>
                                                 <input type="number" class="form-control" name="txt_unitPurchasePrice" required min="1">
                                        </div> <!-- End: Giá nhập  -->

                                        <div class="form-group col-md-3 col-lg-3">
                                            <label for="">Số lượng*</label>
                                            <input type="number" class="form-control" name="txt_qtyProduct" required min="0" max="10000">
                                        </div>
                                    </div> <!-- End: Form-row  -->
                                                    ...
                                                    <div class="form-group">
                                                            <div class="md-4">
                                                                @for($i = 1; $i <= 3 ; $i++) <div class="form-group">
                                                                    <label class="text-success font-weight-bold text-uppercase">Hình ảnh {!! $i !!}</label>
                                                                    <input type="file" class="btn btn-default btn-sm" name="fProductDetail[]" />
                                                            </div>
                                                            @endfor
                                                        </div>    
                                            </div>
                                    ...
                                    <div class="form-group col-md-12 col-lg-12">
                                        ...
                                        <div class="custom-file">
                                            <textarea name="txt_summary" id="txt_summary" cols="30" rows="20"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 col-lg-12">
                                        ...
                                        <div class="custom-file">
                                            <textarea name="txt_description" id="txt_description" cols="30" rows="20"></textarea>
                                        </div>
                                    </div>
                    ...
                    <form action="{{route('editProductById',$dataProductById->id)}}" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    <div class="col-md-3 md-4">
                                            @foreach ($dataProductImage as $item)
                                            @if($item->name!=null)
                                            <img class="mt-4" width="100%" alt="" id="oldThumbimage" src="{{asset("uploads/products/details/$item->name")}}"  />
                                            @endif
                                            @endforeach
                                    </div></div>
                            <div class="form-group col-md-12 col-lg-12">
                                <label for="">Mô tả</label>
                                <div class="custom-file">
                                    <textarea class="w-100" name="txt_summary" id="txt_summary" cols="30" rows="6">{{$dataProductById->summary}}</textarea>
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="">Mô tả chi tiết</label>
...
<div class="row" style="display:{{$showData}};">
    <div class="col-sm-12 col-lg-12 col-xs-12">
        ...
        <div class="table-responsive">
            <table id="table-product" class="table table-striped table-bordered w-100 table-sm" cellspacing="0" cellpadding="4px">
                <thead>
                    <tr >
                ...
                <tbody >
                    ...
                    @if (!empty($dataAllProduct))
                        ...
                        <tr id="tb-product" class="w-100">
                            ...
                            @else
                            <td class="text-truncate text-danger"style="width:10px;">Hết hàng</td>
                            @endif
                            <!-- Hiển thị tên danh mục cha -->
                            ...
                            <td style="min-width:70px;">
                                ...
                                <a href="{{route('deleteProductById',$itemProduct->id)}}" class="btn btn-outline-secondary btn-sm text-danger"> <i class="far fa-calendar-times"></i> </a>  </a>
                                <a href="{{route('getListComment',$itemProduct->id)}}" class="btn btn-outline-secondary btn-sm"> <i class="far fa-comment-alt "></i> </a>  </a>
                            </td>
...
<script>
    ...
    ClassicEditor
        .create( document.querySelector( '#txt_summary' ), {
            toolbar: [ 'heading', '|', 'bold', 'italic', 'link', 'bulletedList', 'numberedList', 'blockQuote' ],
            heading: {
                options: [
                    { model: 'paragraph', title: 'Paragraph', class: 'ck-heading_paragraph' },
