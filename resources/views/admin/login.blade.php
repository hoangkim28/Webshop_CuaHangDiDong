...
<div class="thongbao">
    ...
    <form action="{{route('loginPage')}}" method="post" class="form-signin" role="form" enctype="multipart/form-data">
        ...
        <h1 class="h4 mb-3 font-weight-normal">Trang quản trị</h1>
        <label for="inputEmail" class="sr-only">Email</label>
        <input type="email" id="" name="email" class="form-control" placeholder="Nhập email ..." required autofocus>
        <label for="inputPassword" class="sr-only">Mật khẩu</label>
        <input type="password" id="" name="password" class="form-control" placeholder="Nhập mật khẩu ..." required>
