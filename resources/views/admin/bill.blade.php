...
<div class="row" style="display:{{$showData}};">
    <div class="col-sm-12 col-lg-12 col-xs-12">
        ...
        <div class="table-responsive">
            <table id="table-product" class="table table-bordered w-100 table-sm" cellspacing="0" cellpadding="4px">
                <thead>
                    <tr>
                        <th>Tên sản phẩm</th>
                        <th>SL</th>
                ...
                <tbody id="tbody">
                    ...
                    @if (!empty($dataBill))
                        ...
                        <tr id="tb-product" class="w-100">
                                ...
                                <td class="text-truncate" style="max-width:300px;">
                                    @if (!empty($dataCustomer))
                                        @foreach ($dataCustomer as $itemCustomer)
                                            ...
                                            <span>{{ $itemCustomer->email }}</span>  <br>
                            ...
                            @endif
                                <td class="text-left">
                                    @if (!empty($dataOrderStatus))
                                        @foreach ($dataOrderStatus as $itemOrderStatus)
                                            @if ($itemOrderStatus->id_bill == $itemBill->id)
                                                @if($itemOrderStatus->status == 0)
                                                <a href="{{route('confirmBill',$itemBill->id)}}" class="btn btn-success btn-sm"> <i class="fas fa-check-circle"></i> </a>  </a> 
                                                @endif
                                                <a href="{{route('postDeleteBill',$itemBill->id)}}" class="btn btn-danger btn-sm"> <i class="fas fa-trash"></i> </a>  </a>
                                             @endif
                                        @endforeach
                                    @endif                                   
                                </td>
