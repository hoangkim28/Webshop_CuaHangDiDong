        ...
        <div class="row">
                ...
                <div class="card-group col-sm-6 mb-2" style="float:left;">
                    <div class="card">
                            <a href="{{ route("detailNewsPage",$newsItem->id) }}">
                                <img class="card-img-top" src="{{asset("uploads/news/$newsItem->images ")}}" width="auto"
                                    height="350px"></a>
                        <div class="card-body">
                            <a href="{{ route("detailNewsPage",$newsItem->id) }}">
            ...
            <div class="col-md-4">
                ...
                <div class="clearfix list-group-item list-group-item-action">
                    <img src="{{asset("source/images/admin/AO0VBDJ9_2.jpg")}}" alt="..." class="mx-auto d-block"
                        width="100%" height="">
              ...
              <small class="text-muted">Vừa mới đăng</small> --}}
                ...
                <div class="list-group">
                    <div class="clearfix list-group-item list-group-item-action">
                        <img src="{{asset("source/images/admin/AO0VBDJ9_2.jpg")}}" class="float-left mr-2" width="80px"
                            height="80px">
                        <a href="#">
                            <p>Phong cách thời trang nam tính của siêu sao Tom Cruise...</p>
                        </a>
                    ...
                    <div class="clearfix list-group-item list-group-item-action">
                        <img src="{{asset("source/images/admin/AO0VBDJ9_2.jpg")}}" class="float-left mr-2" width="80px"
                            height="80px">
                        <a href="#">
                            <p>Những xu hướng lên ngôi tại tuần lễ thời trang nam giới xuân hè 2019...</p>
                        </a>
